...
<main>
  ...
  <div class="container flex-column mx-auto my-5 p-5 w-50 justify-content-center bg-light shadow-lg" id ="mainDiv">
    <div class = "d-flex justify-content-between align-items-center mb-3">
      <h3>Categories</h3>
      <button type="button" onclick = "openAddCategoryModal()" class = "btn btn-secondary rounded"  data-bs-toggle="modal"  data-bs-target="#staticBackdrop">
        New
      </button>
    </div>
    <cfoutput>
      ...
      <cfloop array="#variables.queryGetCategories#" item="local.item">
        ...
        <div class = "d-flex justify-content-between align-items-center" id = "#local.item.categoryId#">
          <div id ="categoryname-#local.item.categoryId#">#local.item.categoryName#</div>
          <div>
            <button type="button" 
