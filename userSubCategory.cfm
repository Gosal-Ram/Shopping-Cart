...
<cfparam  name="variables.sortFlag" default = "1">
<cfset variables.subCategoryId = decrypt(url.subCategoryId,application.key,"AES","Base64")>

<cfif structKeyExists(url, "filterMin") AND structKeyExists(url, "filterMax") AND url.filterMax NEQ "" >
    <cfset variables.filterMin = val(url.filterMin)>
    <cfset variables.filterMax = val(url.filterMax)>
</cfif>

<cfif structKeyExists(url, "sortASC")>
    <cfset variables.sortFlag = url.sortASC>
<cfelseif structKeyExists(url, "sortDESC")>
    <cfset variables.sortFlag = url.sortDESC>
</cfif>
    ...
    <div class="container-fluid my-3">
        <div class = "d-flex justify-content-between align-items-center">
            <div>
                ...
                <button class = "btn" name ="sortASC"  type = "submit" value="1">
                    <span class = "min ASC">Price low to High</span>
                </button>
                <button class = "btn" name ="sortDESC" type = "submit" value="2">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <div class="d-flex filterInputContainer justify-content-between w-100">
                        <input class="w-75" type="number"  name="filterMin" placeholder="MIN" value="#variables.filterMin#">
                        <input class="w-75 ms-2" type="number" name="filterMax" placeholder="MAX" value="#variables.filterMax#"> 
                    </div>
        ...
        <div class = "viewEditBtnDiv d-flex justify-content-end me-3" id="viewEditBtnDiv">
