...
<cfset variables.getAllSubCategories = application.shoppingCart.fetchSubCategories( categoryId = variables.categoryId,
                                                                                   getFromCache = false )>
...
<!-- Modal -->
<form method="POST" id="SubCategoryAddForm" onsubmit="saveSubCategoryValidate()">
